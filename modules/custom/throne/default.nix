...
let
  ...
  package = pkgs.callPackage ../../../packages/throne { };
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    security.wrappers = {
      throne-core = lib.mkIf cfg.tunMode.enable {
    ...
    # We use a hack here to determine whether the requested process is throne
    ...
    # 3. Put throne into a systemd service, and let polkit check service name.
